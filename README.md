...
<p>I conducted exploratory tests of the application. I used the Jira tool. I divided the tests into several stages: <i> • homepage • menu • cart and ordering process • user account • product sorting • product pages • search. </i>
</p>
