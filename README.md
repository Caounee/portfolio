...
<p>I conducted exploratory tests of the application. I divided the tests into several stages:

✓ the homepage ✓ the menu ✓ all menu tabs ✓ the cart and ordering process ✓ user account ✓ product sorting ✓ product pages ✓ search.
</p>
