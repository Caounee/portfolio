...
<p>I conducted exploratory tests of the application. I divided the tests into several stages: <i> • homepage • menu • cart and ordering process • user account • product sorting • product pages • search. </i> I used the Jira tool.
</p>
