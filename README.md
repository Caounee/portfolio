...
<p>I conducted exploratory tests of the application. I divided the tests into several stages: <i> • homepage • menu • cart and ordering process • user account • product sorting • product pages • search. </i> During the tests, I checked <i>  • navigation • links • the general appearance of the website. </i> I used the Jira tool.
</p>
